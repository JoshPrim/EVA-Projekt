...
page_rolltreppen = html.Div(children=[
    ...
    html.Div([
        ...
        html.Div([
            ...
            html.H1(style={'margin-left': 'auto', 'margin-right': 'auto', 'text-align': 'center', 'width': '15em',
                           'color': '#000099'}, children='Der Rolltreppenkurator'),
            dcc.Markdown('''
        ...
        html.Div([
            ...
            figure={
                'data': [
                    {'x': ['aktiv', 'inaktiv', 'keine Information'], 'y': [escalatorStateCountACTIVE, escalatorStateCountINACTIVE, escalatorStateCountUNKNOWN], 'type': 'bar', 'name': 'Aufzüge',
        ...
        html.Div([dcc.Graph(
            figure=go.Figure(
                ...
                id='escalator_mid_graph'
                    )], style={'display': 'inline-block', 'text-align': 'center', 'width': '50%', 'margin-left':20, 'vertical-align':'middle', 'horizontal-align':'middle'}),
            #style={'width': '35%', 'text-align': 'left', 'display': 'inline-block', 'padding-top': 10,
            #                   'padding-left': 500, 'padding-bottom': 10}),
