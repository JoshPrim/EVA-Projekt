...
########################################################################################################
#################### Daten für Rolltreppen von Rpyc Server abfragen und verarbeiten ####################
########################################################################################################

graphDataEscalator_rückgabe = proxy.root.createEscalatorGraph()

graphDataEscalator = []
for index, i in enumerate(range(len(graphDataEscalator_rückgabe))):

    graphDataEscalator.append([graphDataEscalator_rückgabe['Datum'][index], graphDataEscalator_rückgabe['Anzahl_Ausfälle'][index]])

graphDataEscalator = pd.DataFrame(graphDataEscalator, columns=['Datum', 'Anzahl_Ausfälle'])
